 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://calc.com/", wsdlLocation = "http://localhost:8080/Calculator/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://calc.com/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Calculator/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calc.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calc.com/", "CalculatorPort"), Calculator.class, features);
    }
