 ...
 * generated in the com.calc package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sum_QNAME = new QName("http://calc.com/", "sum");
    private final static QName _SumResponse_QNAME = new QName("http://calc.com/", "sumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.calc
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.com/", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.com/", name = "sumResponse")
